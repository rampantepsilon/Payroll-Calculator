...
public class PayrollApplication extends JFrame {
    ...
    private final JButton inWeekly, inBiweekly, inSupport, clear;
    ...
    public PayrollApplication(){
        ...
        inSupport = new JButton("Support.com");
        ...
        inSupport.addActionListener(bh);
    ...
    private class ButtonHandler implements ActionListener{
        public void actionPerformed(ActionEvent ae){
            ...
            else if (ae.getSource() == inSupport){
                hoursReg = 80;
                paySchedule = 2;
                origPay = payRate;
            }
